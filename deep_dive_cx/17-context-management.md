...
- [05-query-and-request.md](./05-query-and-request.md)
  负责 `query()` 主循环和调用时序，只保留上下文管理的入口位置
- [09-performance-cache-context.md](./09-performance-cache-context.md)
...
- [15-prompt-system.md](./15-prompt-system.md)
  负责 compact prompt 和相关二级 prompt 的提示词层设计

如果需要抓主线，推荐阅读顺序是：

1. 本篇 [17-context-management.md](./17-context-management.md)
2. [05-query-and-request.md](./05-query-and-request.md)
3. [09-performance-cache-context.md](./09-performance-cache-context.md)
4. [13-session-storage-and-resume.md](./13-session-storage-and-resume.md)
5. [15-prompt-system.md](./15-prompt-system.md)
